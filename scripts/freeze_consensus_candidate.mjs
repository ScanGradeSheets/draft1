...
const manifest = {
  ...
  candidate: 'ScanGrade non-row dual-crop private-beta candidate 3',
  policyVersions: {
  ...
  referenceResult: {
    scorableAnswers: 275,
    pages: 40,
    candidateAutomatic: 237,
    candidateCoveragePct: 86.2,
    candidateAutomaticWrong: 0,
    rowCoveragePct: 90.0,
    nonRowCoveragePct: 80.9,
    numberBondCoveragePct: 59.1,
    promotions: 61,
    reproducibilityPages: 20,
