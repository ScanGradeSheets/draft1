...
- Verification: canonical policy gate pass, visual audit of all 28 changed decisions, ONNX/PyTorch parity pass, active WebKit application pass, 190/190 repository tests, and production build pass. Physical five-year-old-iPad sustained testing is still a required gate before considering public activation.
