...
# 2026-08-01 — Beta 15.65 faster, transition-stable red X

- Physical finding: the live sequential X and its final bitmap looked like
  different reds. They used one hex value but different opacity, compositing,
