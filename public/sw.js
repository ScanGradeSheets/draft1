...
const shellUrls = [
  ...
  new URL('icons/apple-touch-icon-180-v2.png', scopeRoot).href,
  new URL('icons/scangrade-icon-192-v2.png', scopeRoot).href,
  new URL('icons/scangrade-icon-512-v2.png', scopeRoot).href,
  new URL('icons/scangrade-icon-maskable-512-v2.png', scopeRoot).href,
]
