...
const shellUrls = [
  ...
  new URL('icons/apple-touch-icon-180-v3.png', scopeRoot).href,
  new URL('icons/scangrade-icon-192-v3.png', scopeRoot).href,
  new URL('icons/scangrade-icon-512-v3.png', scopeRoot).href,
  new URL('icons/scangrade-icon-maskable-512-v3.png', scopeRoot).href,
]
